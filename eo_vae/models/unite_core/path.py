"""Flow path definitions for UNITE transport.

Copied verbatim from UNITE-tokenization-generation/modules/denoiser_utils/path.py.
"""
...
class ICPlan:
    """Linear Coupling Plan (default for UNITE flow matching)."""
...
class VPCPlan(ICPlan):
    def __init__(self, sigma_min=0.1, sigma_max=20.0):
        ...
        self.d_log_mean_coeff = lambda t: (
            0.5 * (1 - t) * (self.sigma_max - self.sigma_min) + 0.5 * self.sigma_min
        )
