...
class Upsample(nn.Module):
    def __init__(self, in_channels: int, with_conv: bool):
        ...
        Args:
            ...
            with_conv: Whether to use convolution after upsampling
        """
        super().__init__()
...
class Downsample(nn.Module):
    def __init__(self, in_channels: int, with_conv: bool):
        ...
        Args:
            in_channels: Number of input channels
            with_conv: Whether to use convolution for downsampling
        """
        super().__init__()
        self.with_conv = with_conv
        if self.with_conv:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            conv_shortcut: Whether to use convolution in shortcut
